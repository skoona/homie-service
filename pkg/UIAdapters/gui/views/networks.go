...
func (vp *viewProvider) NetworksTab() fyne.CanvasObject {
	...
	card := widget.NewCard("HomeOffice", "80%", widget.NewLabel("motion"))
		card.SetImage(SknCanvasSVGImageFromPath("./docs/sensorsOn-mbr-24px.svg"))
	card1 := widget.NewCard("MediaRoom", "60%", widget.NewLabel("motion"))
		card1.SetImage(SknCanvasSVGImageFromPath("./docs/sensorsOn-mbr-24px.svg"))
	card2 := widget.NewCard("GuestRoom", "49%", widget.NewLabel("motion"))
		card2.SetImage(SknCanvasSVGImageFromPath("./docs/sensorsOn-mbo-24px.svg"))
	card3 := widget.NewCard("Garage", "49%", widget.NewLabel("motion"))
		card3.SetImage(SknCanvasSVGImageFromPath("./docs/sensorsOff-mbr-24px.svg"))
	card4 := widget.NewCard("FrontDoor", "49%", widget.NewLabel("motion"))
		card4.SetImage(SknCanvasSVGImageFromPath("./docs/sensorsOff-mbr-24px.svg"))
	card5 := widget.NewCard("PatioDoor", "49%", widget.NewLabel("motion"))
		card5.SetImage(SknCanvasSVGImageFromPath("./docs/sensorsOff-mbo-24px.svg"))
	card6 := widget.NewCard("FamilyRom", "49%", widget.NewLabel("motion"))
		card6.SetImage(SknCanvasSVGImageFromPath("./docs/sensorsOn-mbr-24px.svg"))
	card7 := widget.NewCard("MechanicalRoom", "49%", widget.NewLabel("motion"))
		card7.SetImage(SknCanvasSVGImageFromPath("./docs/sensorsOn-mbr-24px.svg"))
