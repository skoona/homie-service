...
func SchedulesTab() fyne.CanvasObject {
	...
	card := widget.NewCard("HomeOffice", "80%", widget.NewLabel("motion"))
		card.SetImage(SknCanvasImageFromPath("./docs/calendar-schedule-svgrepo-com.svg"))
	card1 := widget.NewCard("MediaRoom", "60%", widget.NewLabel("motion"))
		card1.SetImage(SknCanvasImageFromPath("./docs/calendar-svgrepo-com.svg"))
	card2 := widget.NewCard("GuestRoom", "49%", widget.NewLabel("motion"))
		card2.SetImage(SknCanvasImageFromPath("./docs/calendar-schedule-svgrepo-com.svg"))
	card3 := widget.NewCard("Garage", "49%", widget.NewLabel("motion"))
		card3.SetImage(SknCanvasImageFromPath("./docs/calendar-schedule-svgrepo-com.svg"))
	card4 := widget.NewCard("FrontDoor", "49%", widget.NewLabel("motion"))
		card4.SetImage(SknCanvasImageFromPath("./docs/calendar-svgrepo-com.svg"))
	card5 := widget.NewCard("PatioDoor", "49%", widget.NewLabel("motion"))
		card.SetImage(SknCanvasImageFromPath("./docs/calendar-schedule-svgrepo-com.svg"))
	card6 := widget.NewCard("FamilyRom", "49%", widget.NewLabel("motion"))
		card6.SetImage(SknCanvasImageFromPath("./docs/calendar-schedule-svgrepo-com.svg"))
	card7 := widget.NewCard("MechanicalRoom", "49%", widget.NewLabel("motion"))
		card7.SetImage(SknCanvasImageFromPath("./docs/calendar-svgrepo-com.svg"))
