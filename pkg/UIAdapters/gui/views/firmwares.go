...
func FirmwaresTab() fyne.CanvasObject {
	...
	card.SetImage( canvas.NewImageFromResource(theme.StorageIcon()))
	card1 := widget.NewCard("MediaRoom", "60%", widget.NewLabel("motion"))
	card1.SetImage( canvas.NewImageFromResource(theme.StorageIcon()))
	card2 := widget.NewCard("GuestRoom", "49%", widget.NewLabel("motion"))
	card2.SetImage( canvas.NewImageFromResource(theme.StorageIcon()))
	card3 := widget.NewCard("Garage", "49%", widget.NewLabel("motion"))
	card3.SetImage( canvas.NewImageFromResource(theme.StorageIcon()))
	card4 := widget.NewCard("FrontDoor", "49%", widget.NewLabel("motion"))
	card4.SetImage( canvas.NewImageFromResource(theme.StorageIcon()))
	card5 := widget.NewCard("PatioDoor", "49%", widget.NewLabel("motion"))
	card5.SetImage( canvas.NewImageFromResource(theme.StorageIcon()))
	card6 := widget.NewCard("FamilyRom", "49%", widget.NewLabel("motion"))
	card6.SetImage( canvas.NewImageFromResource(theme.StorageIcon()))
	card7 := widget.NewCard("MechanicalRoom", "49%", widget.NewLabel("motion"))
	card7.SetImage( canvas.NewImageFromResource(theme.StorageIcon()))
